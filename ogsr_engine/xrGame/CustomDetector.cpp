...
void CCustomDetector::Load(LPCSTR section)
{
    ...
    if (pSettings->line_exist(section, "sndShow"))
        HUD_SOUND::LoadSound(section, "sndShow", sndShow, m_eSoundShow);
    else
        HUD_SOUND::LoadSound(section, "snd_draw", sndShow, m_eSoundShow);
    if (pSettings->line_exist(section, "sndHide"))
        HUD_SOUND::LoadSound(section, "sndHide", sndHide, m_eSoundHide);
    else
